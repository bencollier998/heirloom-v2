...
const COFFEE_LATTES: MenuItem[] = [
  ...
  { category: 'Coffee & Latte', title: 'Spiced Mocha', description: 'Dark chocolate espresso with warming spices and steamed milk.', image: 'https://baking-ginger.com/wp-content/uploads/2022/01/Oat-Milk-Lattes-15-683x1024.jpg', icon: Coffee, ingredients: 'Espresso, dark chocolate, cinnamon, nutmeg, milk', prep: '4–6 min', price: 4.80 },
