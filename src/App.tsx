...
const COFFEE_LATTES: MenuItem[] = [
  { category: 'Coffee & Latte', title: 'Pumpkin Spice Latte', description: 'Velvety espresso with pumpkin spice and steamed milk.', image: 'https://i.pinimg.com/736x/ef/be/19/efbe191b9ac4f417a428380c4240c186.jpg', icon: Coffee, ingredients: 'Espresso, pumpkin spice, whole milk', prep: '3–5 min', price: 4.80 },
  { category: 'Coffee & Latte', title: 'Maple Cinnamon Latte', description: 'Espresso with warm maple syrup and a dusting of cinnamon.', image: 'https://thegourmetbonvivant.com/wp-content/uploads/2023/09/maple-latte-ft.jpg', icon: Coffee, ingredients: 'Espresso, maple syrup, cinnamon, oat milk', prep: '3–5 min', price: 4.80 },
  { category: 'Coffee & Latte', title: 'Hazelnut Latte', description: 'Rich espresso with toasted hazelnut syrup and silky steamed milk.', image: 'https://www.nestlegoodnes.com/esar/sites/default/files/styles/1_1_768px_width/public/srh_recipes/54e34bee32b0ad68439f986d78a99e57.jpeg.webp?itok=EYdYGW4a', icon: Coffee, ingredients: 'Espresso, hazelnut syrup, whole milk', prep: '3–5 min', price: 4.60 },
  { category: 'Coffee & Latte', title: 'Chai Latte', description: 'Spiced chai brewed with black tea, honey and steamed milk.', image: 'https://patissland.fr/cdn/shop/articles/recette-du-chai-latte-patissland.png?v=1777666701', icon: Coffee, ingredients: 'Black tea, cardamom, ginger, honey, milk', prep: '5–8 min', price: 4.20 },
  { category: 'Coffee & Latte', title: 'Honey Oat Latte', description: 'Smooth espresso with golden honey and creamy oat milk.', image: 'https://baking-ginger.com/wp-content/uploads/2022/01/Oat-Milk-Lattes-15-683x1024.jpg', icon: Coffee, ingredients: 'Espresso, honey, oat milk', prep: '3–5 min', price: 4.60 },
  { category: 'Coffee & Latte', title: 'Spiced Mocha', description: 'Dark chocolate espresso with warming spices and steamed milk.', image: 'https://assets.surlatable.com/m/5f630aef87ee569a/72_dpi_webp-REC_298026_Hot_Chocolate-jpg', icon: Coffee, ingredients: 'Espresso, dark chocolate, cinnamon, nutmeg, milk', prep: '4–6 min', price: 4.80 },
  { category: 'Coffee & Latte', title: 'White Mocha', description: 'Creamy white chocolate espresso with velvety steamed milk.', image: 'https://i.pinimg.com/1200x/0f/74/db/0f74db40681d61a85575e989475c8732.jpg', icon: Coffee, ingredients: 'Espresso, white chocolate, whole milk', prep: '3–5 min', price: 4.80 },
];
 
const COLD_DRINKS: MenuItem[] = [
  { category: 'Cold Drinks', title: 'Iced Matcha Maple', description: 'Ceremonial matcha over ice with a drizzle of maple syrup.', image: 'https://veggiekinsblog.com/wp-content/uploads/2024/11/Pumpkin-Butter-Matcha-Latte-2-480x270.jpg', icon: IceCream, ingredients: 'Ceremonial matcha, maple syrup, oat milk, ice', prep: '3 min', price: 4.50 },
  { category: 'Cold Drinks', title: 'Pumpkin Cream Cold Foam', description: 'Cold brew topped with spiced pumpkin cream cold foam.', image: 'https://inbloombakery.com/wp-content/uploads/2022/08/Pumpkin-Cold-Foam-3.jpg', icon: IceCream, ingredients: 'Cold brew, pumpkin spice, cream, ice', prep: '3–5 min', price: 5.00 },
  { category: 'Cold Drinks', title: 'Apple Crisp Macchiato', description: 'Espresso over apple spiced milk with caramel drizzle.', image: 'https://i.pinimg.com/1200x/a5/fc/fb/a5fcfbf22a09b9017e21ea75a070194f.jpg', icon: IceCream, ingredients: 'Espresso, apple spice, caramel, oat milk, ice', prep: '3–5 min', price: 5.20 },
  { category: 'Cold Drinks', title: 'Sparkling Apple Cinnamon', description: 'Pressed apple juice with cinnamon and sparkling water.', image: 'https://i.pinimg.com/1200x/44/49/16/444916d8eddf905ac6e83c776455f43b.jpg', icon: IceCream, ingredients: 'Apple juice, cinnamon, sparkling water, ice', prep: '2 min', price: 3.80 },
];
 
const PASTRIES: MenuItem[] = [
  { category: 'Pastries', title: 'Cinnamon Rolls', description: 'Fluffy rolls swirled with warm cinnamon sugar and cream cheese glaze.', image: 'https://i.pinimg.com/736x/63/41/47/634147e5ce453f4cdd01e10643cf05ab.jpg', icon: Utensils, ingredients: 'Flour, cinnamon, brown sugar, butter, cream cheese', prep: '2 min', price: 3.80 },
  { category: 'Pastries', title: 'Pumpkin Muffins', description: 'Moist spiced pumpkin muffins with a crunchy pecan top.', image: 'https://i.pinimg.com/1200x/9f/61/ee/9f61ee4fd3cb1b10e943aeb19a3d5d50.jpg', icon: Utensils, ingredients: 'Pumpkin, cinnamon, nutmeg, pecan, flour', prep: '2 min', price: 3.20 },
  { category: 'Pastries', title: 'Lemon Poppy Seed Cake', description: 'Light and zesty lemon cake studded with poppy seeds.', image: 'https://bakefromscratch.com/wp-content/uploads/2016/10/LemonThyme094SW.jpg', icon: Utensils, ingredients: 'Lemon zest, poppy seeds, flour, butter, cream', prep: '2 min', price: 3.50 },
  { category: 'Pastries', title: 'Carrot Cake', description: 'Moist spiced carrot cake with cream cheese frosting.', image: 'https://image.jimcdn.com/app/cms/image/transf/none/path/sf51e3555eb28f2f2/image/i18791f7eaed31852/version/1697906872/image.jpg', icon: Utensils, ingredients: 'Carrot, cinnamon, cream cheese, walnuts', prep: '2 min', price: 4.50 },
  { category: 'Pastries', title: 'Banana Bread', description: 'Dense, golden banana bread with toasted walnuts.', image: 'https://ournourishingtable.com/wp-content/uploads/2019/11/Gluten-Free-Dairy-Free-Banana-Bread-10-768x1152.jpg', icon: Utensils, ingredients: 'Banana, walnuts, flour, brown sugar, butter', prep: '2 min', price: 3.20 },
  { category: 'Pastries', title: 'Apple Pie', description: 'Classic flaky pastry filled with spiced Bramley apples.', image: 'https://www.recipetineats.com/tachyon/2022/11/Apple-Pie_8.jpg?resize=500%2C500', icon: Utensils, ingredients: 'Bramley apple, cinnamon, pastry, brown sugar', prep: '5 min', price: 4.50 },
  { category: 'Pastries', title: 'Dirty Brownie', description: 'Fudgy dark chocolate brownie with a salted caramel swirl.', image: 'https://i.pinimg.com/1200x/51/51/54/515154980dbf6653bae46bd6cd39d1ac.jpg', icon: Utensils, ingredients: 'Dark chocolate, salted caramel, butter, eggs', prep: '2 min', price: 3.80 },
  { category: 'Pastries', title: 'Pecan Chocolate Brownie', description: 'Rich chocolate brownie loaded with toasted pecans.', image: 'https://juliemarieeats.com/wp-content/uploads/2025/10/Pecan-Pie-Brownie-4-1-scaled.jpg', icon: Utensils, ingredients: 'Dark chocolate, pecan, butter, eggs, flour', prep: '2 min', price: 3.80 },
  { category: 'Pastries', title: 'Sticky Date Cake', description: 'Warm sticky toffee date cake with butterscotch sauce.', image: 'https://i.pinimg.com/1200x/92/8b/dc/928bdc6aefdf123f999db39948019510.jpg', icon: Utensils, ingredients: 'Medjool dates, butterscotch, cream, flour', prep: '5 min', price: 4.80 },
];
 
const COZY_SNACKS: MenuItem[] = [
  { category: 'Cozy Snack Time', title: 'Classic Grilled Cheese', description: 'Golden toasted sourdough with melted cheddar, served with tomato soup.', image: 'https://i.pinimg.com/1200x/5c/41/5e/5c415ee82e82c5ec1aa7cac1d9f9b0d2.jpg', icon: Sandwich, ingredients: 'Sourdough, mature cheddar, butter, tomato soup', prep: '8–10 min', price: 7.50 },
  { category: 'Cozy Snack Time', title: 'Cheddar Chutney Toastie', description: 'Sharp cheddar and caramelised onion chutney on toasted bloomer.', image: 'https://images.immediate.co.uk/production/volatile/sites/30/2021/07/Mango-chutney-campfire-cheese-toasties-819beb2.jpg', icon: Sandwich, ingredients: 'Cheddar, caramelised onion chutney, bloomer bread', prep: '8 min', price: 7.00 },
  { category: 'Cozy Snack Time', title: 'Brie & Bacon Toastie', description: 'Creamy brie with crispy bacon and wholegrain mustard on sourdough.', image: 'https://i.pinimg.com/1200x/57/93/b6/5793b6df4ee72e71894c9ffa65c7657d.jpg', icon: Sandwich, ingredients: 'Brie, smoked bacon, wholegrain mustard, sourdough', prep: '8–10 min', price: 8.00 },
  { category: 'Cozy Snack Time', title: 'Chicken Stuffing Sandwich', description: 'Roast chicken with sage stuffing and cranberry on malted bread.', image: 'https://i.pinimg.com/1200x/f1/f5/53/f1f553eb0189c96c293546c00ede4ded.jpg', icon: Sandwich, ingredients: 'Roast chicken, sage stuffing, cranberry, malted bread', prep: '5 min', price: 7.50 },
  { category: 'Cozy Snack Time', title: 'Mushroom Cheese Toastie', description: 'Garlic mushrooms with gruyère on thick white toast.', image: 'https://donalskehan.com/wp-content/uploads/grilled-cheese-toastie-5-copy.jpg', icon: Sandwich, ingredients: 'Portobello mushroom, gruyère, garlic, thyme, white bread', prep: '8–10 min', price: 7.50 },
  { category: 'Cozy Snack Time', title: 'Autumnal Veggie Toastie', description: 'Roasted squash, spinach and pesto on granary bread.', image: 'https://i.pinimg.com/736x/72/c3/bc/72c3bc4ac5ec463facabf6b85c09683f.jpg', icon: Sandwich, ingredients: 'Butternut squash, spinach, pesto, granary bread', prep: '8 min', price: 7.00 },
];
